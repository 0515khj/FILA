...
- **상품 탐색의 비효율성**: 과도하게 큰 이미지와 SNS형 레이아웃으로 인해 한 화면에서 다양한 상품을 비교/탐색하기 어려움
- **상품 정보 가시성 부족**: 실제 상품 정보(가격, 옵션)보다 브랜드 이미지만 부각되어 쇼핑 정보 확인이 불편함
- **구매 유도 기능 약화**: '쇼핑'이라는 본질적 기능보다 시각적 연출에 치우쳐, 실제 구매로 이어지는 동선이 직관적이지 않음
